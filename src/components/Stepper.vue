    ...
    <ol role="list" class="flex items-center  mx-auto">
      ...
      >
        ...
        <div v-if="currentPage > index + 1">
          ...
          <a @click="onStepperClick(index+1)" href="#" class="relative flex h-8 w-8 items-center justify-center rounded-full bg-lime-400 border-2 border-lime-700 hover:bg-lime-300  drop-shadow">
            <svg class="h-5 w-5 text-lime-950" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
