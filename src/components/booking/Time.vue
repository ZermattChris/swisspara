<template>
  ...
  <div id="flightDateBox" class="mx-auto pb-1 md:pb-6 pl-[3vw] sm:pl-0 w-full max-w-lg sm:w-3/4 md:w-4/5 lg:w-1/2  ">
  ...
  <div class="flex justify-center   text-sm  mt-0 mb-4 mx-auto max-w-md">
