<template>
  ...
  <div id="flightDateBox" class="mx-auto pb-4 md:pb-6 pl-[3vw] w-full max-w-lg sm:w-3/4 md:w-4/5 lg:w-1/2  ">
    ...
    <p>Ms. Ellis admitted that the allegations of election fraud she peddled as an advocate for the effort to overturn
      the 2020 election were false. Two other plea deals, from Kenneth Chesebro and </p>
  ...
  <div id="sliderWrapper" class="px-0 pt-4 max-w-screen-2xl m-auto">
    ...
    <TimeSlider v-if="loading === false" :data="timeSlotList" @pagevalid="onTimeSliderUpdated"></TimeSlider>
  </div> <!-- End: Wrapper -->
